  ...
  return (
    <div className="flex flex-col min-h-screen gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col  items-center sm:items-start w-full">
        <section
          id="inicio"
          className="w-full flex flex-col items-center sm:pt-16" // Ajustar el padding top
        >
        ...
        <div className="w-full border-gray-300 my-10"></div> {/* Reducido el margin top y bottom */}

        {/* Sección Proyectos */}
        <section
          id="proyectos"
          className="flex flex-col sm:flex-row items-center sm:justify-between gap-8 p-8 bg-gray-50 w-full"
        >
          <div className="w-full sm:w-1/2">
            <h1 className="text-4xl text-center sm:text-left m-3 p-3 font-light w-full">
              Nuestros Proyectos
            </h1>
            <p className="text-justify text-xl m-3 p-3 font-light w-full sm:max-w-3xl">
        ...
        <div className="w-full border-gray-300 my-10"></div>

        {/* Sección Nosotros */}
        <section
          id="nosotros"
          className="flex flex-col sm:flex-row items-center sm:justify-between gap-8 p-8 bg-gray-100 w-full"
        >
          <div className="w-full sm:w-1/2">
            <h1 className="text-4xl text-center sm:text-left m-3 p-3 font-light w-full">
              Nosotros
      ...
      <footer className="flex gap-6 text-sm flex-wrap items-center justify-center w-full">
        <div>
          <p className="text-center text-gray-500 font-light">
            &copy; {new Date().getFullYear()} ADMA | Todos los derechos reservados
          </p>
        </div>
        <div>
          <a
