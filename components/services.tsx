...
const Images = [
  ...
  {
    id: 4,
    title: 'Creación de Páginas Web para Inmobiliarias',
    description: 'Desarrollamos sitios web personalizados para inmobiliarias, optimizados para destacar tus propiedades y atraer a clientes potenciales. Incluimos bases de datos, galerías de fotos, mapas interactivos y más.',
          ...
          {Images.map((image) => (
            ...
            >
              ...
              <div className="p-6 flex-1">
                <h2 className="font-semibold text-xl mb-3 font-sans text-gray-800">
                  {image.title}
                </h2>
              ...
              <div className="p-6 flex justify-end mt-auto">
                <Button
                  className="bg-[--tertiary] hover:bg-[--secondary] hover:text-[--foreground] font-sans hover:border-2 font-bold py-2 px-6 rounded-xl"
                  onClick={() =>
                    (window.location.href = "https://wa.me/18495153010")
                  }
                >
                  Cotizar
                </Button>
